...
namespace Photon.Voice.Unity
{
    ...
    public class Recorder : VoiceComponent
    {
        ...
        public static event Action OnMicrophoneUpdate;
        ...
        private LocalVoice CreateLocalVoiceAudioAndSource()
        {
            switch (this.SourceType)
            {
                ...
                // mic can ignore passed sampling rate and set its own
                    ...
                    //THIS IS THE EDIT
                    MicWrapper mic = new MicWrapper(micDev, (int)this.SamplingRate, this.Logger);
                    micClip = mic.mic;
                    this.inputSource = mic;
                    if (OnMicrophoneUpdate != null) { 
                        Recorder.OnMicrophoneUpdate();
                    }
                    //END OF EDIT
