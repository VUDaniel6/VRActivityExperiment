...
{
    public static OVRLipSyncMicInput instance;
    ...
    void Start()
    {
        ...
        Recorder.OnMicrophoneUpdate += StartMicrophone;
    }
    ...
    void Update()
    {
        ...
        if (micControl == micActivation.ConstantSpeak)
        {
            ...
            */
            InvokeRepeating("StartMicrophone", 0, 1);
        }
    ...
    public void StartMicrophone() {
        ...
        //Starts recording
        audioSource.clip = Recorder.micClip;
        //Microphone.Start(selectedDevice, true, 1, micFrequency);
